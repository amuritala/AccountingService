...
public class MultiJrnlAuthCreateIOType {
    ...
    protected List<MultiJrnlAuthCreateIOType.CsvwContractOvdAuth> csvwContractOvdAuth;
     ...
     * This is why there is not a {@code set} method for the csvwContractOvdAuth property.
     * 
     * <p>
     ...
     * {@link MultiJrnlAuthCreateIOType.CsvwContractOvdAuth }
     * 
     * 
     * @return
     *     The value of the csvwContractOvdAuth property.
     */
    public List<MultiJrnlAuthCreateIOType.CsvwContractOvdAuth> getCsvwContractOvdAuth() {
        if (csvwContractOvdAuth == null) {
            csvwContractOvdAuth = new ArrayList<>();
        }
